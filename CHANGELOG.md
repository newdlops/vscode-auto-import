...
- **Cross-platform CI** (`.github/workflows/build.yml`) builds the daemon for `darwin-arm64 / darwin-x64 / linux-x64 / linux-arm64 / win32-x64` and produces a single `.vsix` containing every binary.
